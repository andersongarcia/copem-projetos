...
<div class="actions">
    <ul>
        <li><?php echo $html->link($html->image('delete.png', array('alt' =>__('Excluir', true))), array('action' => 'delete', $form->value('Contrato.id')), null, sprintf(__('Você tem certeza que deseja excluir # %s?', true), $form->value('Contrato.id')), false, false).' '.$html->link(__('Excluir', true), array('action' => 'delete', $form->value('Contrato.id')), null, sprintf(__('Você tem certeza que deseja excluir # %s?', true), $form->value('Contrato.id')));
; ?></li>
        ...
        <li><?php echo $html->link($html->image('add.gif', array('alt' => __('Adicionar Contratos Registros Profissionais', true))), array('controller' => 'contratos_registros_profissionais', 'action' => 'add'), null, false, false).' '.$html->link(__('Adicionar Contratos Registros Profissionais', true), array('controller' => 'contratos_registros_profissionais', 'action' => 'add')); ?> </li>
    </ul>
</div>
