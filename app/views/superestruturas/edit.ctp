...
<div class="superestruturas form">
    ...
    <fieldset>
        <legend><?php __('Editar Superestrutura');?></legend>
        <?php
        echo $form->input('id');
            ...
            if($campo['formulario_id']==2) {
                ...
                switch ($campo['Cadastro']['tipo']) {
                    ...
                    case "VALOR":
                        ...
                        break;
                    default:
                        if($campo['Cadastro']['campo_chave']=='projeto_padrao') {
                            ?>
        ...
        <div class="subform">
            ...
            <div id="ObraEmLaje">
                <?php
                    ...
                    echo $form->input('ObraEmLaje.tipo', array('options'=>array('Maciça'=>'Maciça','Alveolar'=>'Alveolar','Outros'=>'Outros'),'empty'=>'Selecione...'));
...
<div class="actions">
    <ul>
        <li><?php echo $html->link($html->image('delete.png', array('alt' =>__('Excluir', true))), array('action' => 'delete', $form->value('Superestrutura.id')), null, sprintf(__('Você tem certeza que deseja excluir # %s?', true), $form->value('Superestrutura.id')), false, false).' '.$html->link(__('Excluir', true), array('action' => 'delete', $form->value('Superestrutura.id')), null, sprintf(__('Você tem certeza que deseja excluir # %s?', true), $form->value('Superestrutura.id')));
            ; ?></li>
        <li><?php echo $html->link($html->image('list.png', array('alt' => __('Cancelar', true))), array('controller'=>'projetos','action' => 'view','id'=>$form->value('Projeto.id')), null, false, false).' '.$html->link(__('Cancelar', true), array('controller'=>'projetos','action' => 'view','id'=>$form->value('Projeto.id')))
            ;?></li>
    </ul>
</div>